...
const Honduras: React.FC = () => {
  ...
  "@type": "WebPage",
  name: "Internet in Honduras | Connectivity, ISPs & Broadband Overview",
  description:
    "Overview of Honduras' internet connectivity, submarine and terrestrial routes, ISPs, broadband market and inte-QT capabilities across Tegucigalpa, San Pedro Sula, La Ceiba and other key centres.",
  url: "https://www.inte-qt.com/coverage/north-america/honduras",
  about: {
    "@type": "Country",
    name: "Honduras",
    capital: {
  ...
  <link
    rel="canonical"
    href="https://www.inte-qt.com/coverage/north-america/honduras"
  />
