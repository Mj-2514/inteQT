...
const CostaRica: React.FC = () => {
  ...
  "@type": "WebPage",
  name: "Internet in Costa Rica | Connectivity, ISPs & Broadband Overview",
  description:
    "Detailed overview of Costa Rica's internet connectivity, submarine and terrestrial fiber routes, telecom operators, broadband statistics and inte-QT service capabilities in San José, Alajuela, Heredia and other key cities.",
  url: "https://www.inte-qt.com/coverage/latin-america/costa-rica",
  about: {
    "@type": "Country",
    name: "Costa Rica",
    capital: {
