...
const Haiti: React.FC = () => {
  ...
  "@type": "WebPage",
  name: "Internet in Haiti | Connectivity, ISPs & Broadband Overview",
  description:
    "Overview of Haiti's internet connectivity, submarine and terrestrial routes, ISPs, broadband market and inte-QT capabilities across Port-au-Prince, Cap-Haïtien and other key centres.",
  url: "https://www.inte-qt.com/coverage/caribbean/haiti",
  about: {
    "@type": "Country",
    name: "Haiti",
    capital: {
    ...
    officialLanguage: ["Haitian Creole", "French"],
    currency: "HTG",
    population: {
  ...
  <link
    rel="canonical"
    href="https://www.inte-qt.com/coverage/caribbean/haiti"
  />
