 ...
 const submit = async () => {
  ...
  return (
    <div className="p-10 max-w-lg mx-auto">
      ...
      <input placeholder="Email (@inte-qt.com)" value={email} onChange={e=>setEmail(e.target.value)} className="input mt-3"/>
      <input placeholder="Temporary Password" value={tempPassword} onChange={e=>setTempPassword(e.target.value)} className="input mt-3"/>
