        ...
        <main className="mx-auto max-w-6xl px-4 py-6 md:py-8">
          ...
          >
            <div>
              ...
              <p className="text-xs text-slate-400">
                As admin, you can edit and delete any blog from here.
              </p>
            </div>
          ...
          {loading ? (
            ...
            <motion.div
              initial="hidden"
              animate="visible"
              className="overflow-hidden rounded-2xl border border-white/10 bg-slate-900/80 shadow-2xl shadow-black/40"
            >
              ...
              <div className="hidden flex-col md:flex">
                {blogs.map((blog, idx) => (
                  <motion.div
                    ...
                    variants={fadeUp}
                    custom={idx}
                    className="grid grid-cols-[1.6fr_1fr_0.7fr_0.7fr] items-center gap-4 border-b border-white/5 px-5 py-3 last:border-b-0"
                  >
                    ...
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-full border border-sky-400/60 px-3 py-1 text-xs text-sky-200 hover:bg-sky-500/10"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-full border border-rose-500/60 px-3 py-1 text-xs text-rose-200 hover:bg-rose-500/10 disabled:opacity-60"
                      >
              ...
              <div className="flex flex-col gap-3 p-4 md:hidden">
                {blogs.map((blog, idx) => (
                  <motion.div
                    ...
                    variants={fadeUp}
                    custom={idx}
                    className="rounded-xl border border-white/10 bg-slate-900/90 p-3 text-xs text-slate-200"
                  >
                    ...
                    <div className="mt-3 flex justify-end gap-2">
                      <button
                        ...
                        className="inline-flex items-center gap-1 rounded-full border border-sky-400/60 px-2.5 py-1 text-[11px] text-sky-200"
                      >
                      ...
                      <button
                        onClick={() => handleDelete(blog._id)}
                        disabled={deletingId === blog._id}
                        className="inline-flex items-center gap-1 rounded-full border border-rose-500/60 px-2.5 py-1 text-[11px] text-rose-200 disabled:opacity-60"
                      >
