...
const Home: React.FC = () => {
  ...
  // === SEO values ===
  const title = "Global Internet Provider in 190+ Countries | Dedicated Line & SD-WAN Underlay – inte-QT";
  const description =
  ...
  return (
    <div className="min-h-screen">
      <Seo
        ...
        image={image}
        siteName={siteName}
        extraJsonLd={[orgJson, websiteJson, breadcrumbJson]}
      />
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            <Button asChild size="lg" className="gradient-primary shadow-glow text-lg px-6 py-3 w-full sm:w-auto">
              <Link to="/services" aria-label="Explore Services">
                Explore Services <ArrowRight className="ml-2 w-5 h-5 inline-block" />
              </Link>
            </Button>

            <Button asChild size="lg" variant="outline" className="text-lg px-6 py-3 border-2 w-full sm:w-auto">
              <Link to="/contact" aria-label="Get Started">Get Started</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-base sm:text-lg text-muted-foreground">Comprehensive connectivity solutions</p>
          </div>
                ...
                >
                  <Card className="relative overflow-hidden rounded-2xl shadow-xl h-[320px] group cursor-pointer">
                    <div
                      ...
                      aria-hidden="true"
                    />
                    <div className="absolute inset-0 bg-black/40 group-hover:bg-black/50 transition-all" aria-hidden="true" />
                    ...
                    <CardContent className="relative z-10 h-full flex flex-col justify-end p-6 text-white">
                      ...
                      {service.subtitle && <p className="text-sm opacity-90 -mt-1">{service.subtitle}</p>}
                      <p className="text-xs sm:text-sm opacity-80 mt-2 leading-relaxed">{service.description}</p>
                    </CardContent>
                  </Card>
                </Link>
              );
          ...
          <div className="text-center mt-8">
            <Button asChild size="lg" variant="outline" className="border-2 w-full sm:w-auto">
              <Link to="/coverage" aria-label="Coverage"> <Globe className="mr-2 inline-block w-5 h-5" /> We cover 190+ countries across the globe</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold mb-3">Why become our partner?</h2>
            <p className="text-base sm:text-lg text-muted-foreground">Join our global network</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {partnerBenefits.map((benefit, i) => {
              ...
              return (
                <Card key={i} className="text-center hover:shadow-glow transition-all duration-300 hover:scale-105">
                  <CardContent className="p-6">
                    <Icon className="w-10 h-10 mx-auto mb-3 text-primary" aria-hidden="true" />
          ...
          <div className="text-center mt-8">
            <Button asChild size="lg" className="gradient-primary shadow-glow">
              <Link to="/partner-center" aria-label="Partner Center"> Learn More <ArrowRight className="ml-2 inline-block" /></Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${nsocImage})` }} aria-hidden="true" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold">Sit back &amp; Relax, We got our <span className="text-gradient">EYES</span> on it</h2>
            </div>
            <p className="text-base sm:text-lg mb-6">24×7 Global Network Security Operations Center</p>
            <Button asChild size="lg" className="gradient-primary shadow-glow">
              <Link to="/cases" aria-label="Explore NSOC">Explore NSOC 24X7 <ArrowRight className="ml-2 inline-block" /></Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-3xl sm:text-4xl font-bold mb-3">We help not One, but many Industries</h2>
            <p className="text-base sm:text-lg text-muted-foreground">Trusted by leading sectors worldwide</p>
          </div>

          <div className="overflow-hidden py-6">
            <div className="flex space-x-6 animate-scroll" aria-hidden="true">
              {industries.concat(industries).map((industry, i) => {
                const Icon = industry.icon;
                return (
                  <div key={i} className="flex flex-col items-center space-y-3 p-4 rounded-xl bg-card min-w-[110px]">
      ...
      <section className="py-16 sm:py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-base sm:text-lg text-muted-foreground">Meet us at industry leading events</p>
          </div>
            ...
            {events.map((event, idx) => (
              <Card key={idx} className="overflow-hidden hover:shadow-lg transition-all duration-300">
                <div className="w-full h-56 overflow-hidden rounded-t-xl">
                  <img src={event.img} alt={event.title} loading="lazy" className="w-full h-full object-cover transition-transform duration-300 hover:scale-105" />
                </div>
                <CardContent>
                  <div className="flex items-start gap-3 mb-3">
                    <Calendar className="w-5 h-5 text-primary mt-1" aria-hidden="true" />
                    <div>
                  ...
                  <Button asChild variant="link" className="text-primary px-0">
                    <Link to="/events" aria-label={`Read more about ${event.title}`}>Read more <ArrowRight className="ml-1 w-4 h-4 inline-block" /></Link>
                  </Button>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="text-center mt-8">
            <Button asChild size="lg" variant="outline" className="border-2 w-full sm:w-auto">
              <Link to="/events" aria-label="View all events">View All Events</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      {/* TESTIMONIAL */}
      <section className="relative py-20 sm:py-28 overflow-hidden" aria-label="Client testimonials">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url("https://cdn.pixabay.com/photo/2019/07/16/11/39/charles-4341624_1280.jpg")' }} aria-hidden="true" />
        ...
        <div className="relative container mx-auto px-4 text-center text-white max-w-4xl">
          ...
          <Card className="bg-white/10 backdrop-blur-m border-white/20 shadow-2xl mx-auto rounded-3xl">
            <CardContent className="p-6 sm:p-8">
              <div className="flex justify-center mb-4">{[...Array(5)].map((_, i) => <Award key={i} className="w-6 h-6 text-yellow-400" />)}</div>
              <p className="text-xl sm:text-2xl font-bold mb-4">BRILLIANT work by inte-QT.</p>
              <p className="text-base sm:text-lg text-white/80 mb-4">It was seamlessly managed by inte-QT, right from quotation to timely delivery within the event schedule. A truly delightful experience.</p>
      ...
      <section className="py-16 sm:py-20 gradient-hero text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-base sm:text-lg mb-6">Contact us and our team will resolve your concerns</p>
          <Button asChild size="lg" variant="secondary" className="text-lg px-6 py-3">
            <Link to="/contact" aria-label="Get in touch">Get In Touch <ArrowRight className="ml-2 inline-block" /></Link>
          </Button>
        </div>
      </section>
    </div>
