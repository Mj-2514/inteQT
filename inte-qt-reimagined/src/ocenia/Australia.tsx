...
const Australia: React.FC = () => {
  ...
  "@type": "WebPage",
  name: "Internet in Australia | Connectivity, ISPs & Broadband Overview",
  description:
    "Overview of Australia’s internet connectivity, fixed and mobile broadband, submarine cable and backbone routes, and inte-QT service capabilities in Sydney, Melbourne, Brisbane, Perth and other key regions.",
  url: "https://www.inte-qt.com/coverage/oceania/australia",
  about: {
    "@type": "Country",
    name: "Australia",
    capital: {
  ...
  return (
    <>
      <Helmet>
  <title>Internet in Australia | Connectivity, ISPs & Broadband Overview</title>
