...
const Guinea: React.FC = () => {
  const jsonLd = {
    ...
    "@type": "WebPage",
    name: "Internet in Guinea | Connectivity, ISPs & Broadband Overview",
    description:
      "Overview of Guinea's internet connectivity, submarine & terrestrial routes, ISPs, broadband market and inte-QT capabilities in Conakry, Nzérékoré, Kankan and other key centres.",
    url: "https://www.inte-qt.com/coverage/africa/guinea",
    about: {
      "@type": "Country",
      name: "Guinea",
      population: 14800000,
      currency: "GNF (Guinean franc)",
      languages: ["French", "Pular", "Malinké", "Susu"],
      neighbouringCountries: ["Guinea-Bissau", "Senegal", "Mali", "Côte d’Ivoire", "Liberia", "Sierra Leone"],
      majorCities: ["Conakry", "Nzérékoré", "Kankan", "Kindia", "Labé"]
    }
  };
  ...
  return (
    <>
      <Helmet>
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Internet in Guinea | Connectivity, ISPs & Broadband Overview" />
        <meta property="og:description" content="Overview of Guinea's internet connectivity, submarine & terrestrial routes, ISPs and broadband market." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.inte-qt.com/coverage/africa/guinea" />
        {/* <meta property="og:image" content="https://www.inte-qt.com/assets/guinea-hero-1200x630.jpg" /> */}

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Internet in Guinea | Connectivity & ISPs" />
        <meta name="twitter:description" content="Overview of Guinea's internet connectivity and submarine/terrestrial routes." />
      ...
      <section className="relative py-20 md:py-28 overflow-hidden" aria-labelledby="hero-title">
        <motion.div
          ...
          style={{
            backgroundImage:
              'url("https://images.unsplash.com/photo-1621862681383-11bfff7588e7?w=1600&auto=format&fit=crop&q=80")'
          }}
          aria-hidden
        />
                ...
                <Card className="backdrop-blur-xl bg-white/80 dark:bg-black/30 rounded-2xl border border-white/10 shadow">
                  <CardContent className="p-6 md:p-8">
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed">
                      <li><strong>Official Name:</strong> Republic of Guinea</li>
                      <li><strong>Population:</strong> ≈ 14.7–14.9 million (2025 est.)</li>
                      <li><strong>Capital & Main Cities:</strong> Conakry, Nzérékoré, Kankan, Kindia, Labé</li>
                      <li><strong>Languages:</strong> French (official); Pular, Malinké, Susu</li>
                      <li><strong>Currency:</strong> Guinean franc (GNF)</li>
                    </ul>
                      ...
                      <div className="rounded-xl overflow-hidden shadow-sm border border-white/10">
                        <div className="w-full aspect-[16/9]">
                          <iframe
                            ...
                            aria-label="Map showing Guinea and main cities"
                          />
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="rounded-2xl border border-white/8 shadow-sm">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                        <li>Ahmed Sékou Touré International Airport (Conakry — CKY)</li>
                        <li>Regional airports: Nzérékoré, Kankan, Labé</li>
                      </ul>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="rounded-2xl border border-white/8 shadow-sm">
                    <CardContent className="p-4 md:p-6">
                      ...
                      <p className="text-muted-foreground mb-4 leading-relaxed">
                        The ACE submarine cable provides international capacity to Conakry; national backbone projects distribute capacity inland. Mobile operators provide most consumer access while enterprises rely on fibre and leased circuits from Conakry PoPs.
                      </p>
                        ...
                        <table className="w-full border-collapse text-sm" role="table" aria-label="Connectivity estimates and notes">
                          ...
                          <tbody>
                            <tr className="border-t border-muted/30">
                              ...
                              <td className="py-3 px-3">≈ 14.7–14.9 million</td>
                              <td className="py-3 px-3">Rapid population growth with urban concentration in Conakry.</td>
                            </tr>

                            <tr className="border-t border-muted/30">
                              <td className="py-3 px-3">Mobile & Internet</td>
                              <td className="py-3 px-3">Mobile-first; improving fixed broadband</td>
                              <td className="py-3 px-3">Operators expanding LTE and fibre to urban areas.</td>
                            </tr>

                            <tr className="border-t border-muted/30">
                              <td className="py-3 px-3">Currency</td>
                              <td className="py-3 px-3">Guinean franc (GNF)</td>
                              <td className="py-3 px-3">Issued by the Central Bank of Guinea.</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
          ...
          <div className="container mx-auto px-4 max-w-6xl space-y-8">
            <Card className="rounded-2xl border border-white/8 shadow">
              <CardContent className="p-6 md:p-8 text-center">
                <h2 className="text-2xl md:text-3xl font-bold mb-4">Submarine Cables & Regional Routes</h2>

                <p className="text-muted-foreground mb-6 leading-relaxed max-w-3xl mx-auto">
                  Conakry is a landing point for the ACE submarine cable which connects multiple West African capitals to European transit hubs. These undersea systems and national backbone projects provide the main international transit for Guinea.
                </p>
                ...
                <div className="flex justify-center">
                  <a
                    ...
                    aria-label="Submarine cable map for Guinea"
                  >
                    <img
                      src="/Guinea.png"
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <ul className="text-muted-foreground space-y-1">
              ...
              <li><a href="https://en.wikipedia.org/wiki/Guinea" target="_blank" rel="noopener noreferrer" className="underline">Wikipedia — Guinea</a></li>
